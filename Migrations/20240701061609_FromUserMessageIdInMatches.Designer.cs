...
namespace YourMatchTgBot.Migrations
{
    ...
    [Migration("20240701061609_FromUserMessageIdInMatches")]
    partial class FromUserMessageIdInMatches
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YourMatchTgBot.Models.Match", b =>
                {
                    b.Property<long>("MatchFromUserId")
                        .HasColumnType("INTEGER");

                    b.Property<long>("MatchToUserId")
                        .HasColumnType("INTEGER");

                    b.Property<DateTime>("Time")
                        .HasColumnType("TEXT");

                    b.Property<int>("FromUserMessageId")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("Handled")
                        .HasColumnType("INTEGER");

                    b.HasKey("MatchFromUserId", "MatchToUserId", "Time");

                    b.HasIndex("MatchToUserId");
            ...
            modelBuilder.Entity("YourMatchTgBot.Models.User", b =>
                {
                    ...
                    b.Property<int>("CurrentFoundUsersCount")
                        .HasColumnType("INTEGER");

                    b.Property<int>("CurrentOffset")
                        .HasColumnType("INTEGER");

                    b.Property<long?>("CurrentUserForMatchId")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("CurrentUserForMatchMessageId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("CurrentUserForMatchId");
            ...
            modelBuilder.Entity("YourMatchTgBot.Models.Match", b =>
                {
                    b.HasOne("YourMatchTgBot.Models.User", "MatchFromUser")
                        .WithMany()
                        .HasForeignKey("MatchFromUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("YourMatchTgBot.Models.User", "MatchToUser")
                        .WithMany()
                        .HasForeignKey("MatchToUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MatchFromUser");

                    b.Navigation("MatchToUser");
                });
            ...
            modelBuilder.Entity("YourMatchTgBot.Models.User", b =>
                {
                    ...
                    b.HasOne("YourMatchTgBot.Models.User", "CurrentUserForMatch")
                        .WithMany()
                        .HasForeignKey("CurrentUserForMatchId");

                    b.Navigation("City");

                    b.Navigation("CurrentUserForMatch");
                });
