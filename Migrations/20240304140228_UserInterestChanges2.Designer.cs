...
namespace YourMatchTgBot.Migrations
{
    ...
    [Migration("20240304140228_UserInterestChanges2")]
    partial class UserInterestChanges2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TempInterestUser", b =>
                {
                    b.Property<int>("TemporaryInterestsInterestId")
                        .HasColumnType("INTEGER");

                    b.Property<long>("UsersId")
                        .HasColumnType("INTEGER");

                    b.HasKey("TemporaryInterestsInterestId", "UsersId");

                    b.HasIndex("UsersId");

                    b.ToTable("TempInterestUser");
                });
            ...
            modelBuilder.Entity("TempInterestUser", b =>
                {
                    b.HasOne("YourMatchTgBot.Models.TempInterest", null)
                        .WithMany()
                        .HasForeignKey("TemporaryInterestsInterestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
