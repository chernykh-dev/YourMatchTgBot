...
namespace YourMatchTgBot.Migrations
{
    ...
    [Migration("20240304135802_UserInterestChanges")]
    partial class UserInterestChanges
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TempInterestUser", b =>
                {
                    b.Property<int>("TemporaryInterestsId")
                        .HasColumnType("INTEGER");

                    b.Property<long>("UsersId")
                        .HasColumnType("INTEGER");

                    b.HasKey("TemporaryInterestsId", "UsersId");
            ...
            modelBuilder.Entity("TempInterestUser", b =>
                {
                    b.HasOne("YourMatchTgBot.Models.TempInterest", null)
                        .WithMany()
                        .HasForeignKey("TemporaryInterestsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
